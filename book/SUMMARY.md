...
* [L'Architecture Elm](architecture/README.md)
   ...
   * [Formulaires](architecture/forms.md)
* [Les types](types/README.md)
   * [Lire les types](types/reading_types.md)
   * [Les alias de type](types/type_aliases.md)
...
* [Applications web](webapps/README.md)
   * [Navigation](webapps/navigation.md)
   * [Parsing d'URL](webapps/url_parsing.md)
...
* Annexes
   * [Les types en tant qu'ensembles](appendix/types_as_sets.md)
   * [Les types en tant que bits](appendix/types_as_bits.md)
